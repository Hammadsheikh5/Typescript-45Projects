...
let x :number = 5;
let y :number = 3;
let Str1 : string = "Hammad";  
let Str2 : string = "Sheikh";
let Name : string = "HAMMAD";
let array1 : number[] = [1,5,6,9,8];

// Tests for equality and inequality with strings
console.log("Is 'Str1' equal 'Hammad'? I predict True.");
console.log(Str1 == "Hammad");

console.log("Is 'Str1' not equal 'Str2'? I predict True.");
console.log(Str1 != Str2);

// Tests using the lower case function
console.log("Is 'Name' equal to 'hammad' when it is in lowercase ? I predict True.");
